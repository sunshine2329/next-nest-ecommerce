...
export const getCurrentUser = (accessToken: string) => async (dispatch: Dispatch<UserAction>) => {
  const config = {
    headers: {
...
export const updateUser =
  (userCredentials: Partial<UserCredentials>) => async (dispatch: Dispatch<UserAction>) => {
    const config = {
      withCredentials: true
    }
    ...
    try {
      ...
      const { data } = await proshopAPI.put('/auth/profile', userCredentials, config)
...
export const deleteUser = (id: string) => async (dispatch: Dispatch<UserAction>) => {
  const config = {
    withCredentials: true
  }
...
export const fetchUser = (id: string) => async (dispatch: Dispatch<UserAction>) => {
  const config = {
    withCredentials: true
  }
...
export const adminUpdateUser =
  (id: string, userCredentials: UserEditCredentials) => async (dispatch: Dispatch<UserAction>) => {
    const router = useRouter()
    const config = {
      withCredentials: true
    }
    ...
    try {
      ...
      const { data } = await proshopAPI.put(`/users/${id}`, userCredentials, config)
