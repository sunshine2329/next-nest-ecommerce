...
export const removeFromCart = (id: string) => async (dispatch: Dispatch<CartAction>) => {
  try {
...
export const saveShippingAddress =
  (shippingDetails: ShippingDetails) => async (dispatch: Dispatch<CartAction>) => {
    try {
      const { data } = await proshopAPI.post('/cart/shipping', shippingDetails, {
        withCredentials: true
      })
